...
-- This also always chooses two different parents
...
onePointCrossover (h1, h2) seed =
                                  ...
                                  where i = getRandomIndex seed h1
